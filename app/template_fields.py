...
TABLE_FIELDS = {
    ...
    "duration":      {"label": "Ladedauer",         "type": "duration", "synonyms": ["dauer", "ladedauer", "ladezeit", "duration", "zeitdauer", "charging_time", "total_duration"]},
    "duration_hours":   {"label": "Ladedauer (h)",       "type": "number",   "synonyms": ["dauer h", "dauer stunden", "ladezeit h", "stunden", "stunden h", "charging time h", "ladezeit in h", "ladezeit (h)"]},
    ...
    "cost_eur":      {"label": "Kosten (€)",        "type": "currency", "synonyms": ["kosten", "cost", "betrag", "ladekosten", "eur", "€", "gesamtbetrag", "summe", "betrag eur", "gesamtkosten session"]},
    "price_per_kwh": {"label": "Preis/kWh",         "type": "currency", "synonyms": ["preis/kwh", "preis pro kwh", "preis je kwh", "kosten pro kwh", "kwh preis", "strompreis", "tarif", "preis kwh", "€/kwh", "eur/kwh"]},
    "price_source":  {"label": "Preisquelle",        "type": "text",     "synonyms": ["preisquelle", "price source", "kostenquelle", "quelle", "preisinformation"]},
    "charging_contract_name": {"label": "Vertragsname", "type": "text",  "synonyms": ["vertrag", "ladevertrag", "contract", "ladeabo", "anbieter", "vertragsname", "abo", "tarif name", "vertragstarif"]},
    "charging_contract_id":   {"label": "Vertrags-ID",  "type": "text",  "synonyms": ["vertrags-id", "contract id", "abo-id", "vertrag id", "contract_id"]},
