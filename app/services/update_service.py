...
def get_update_info(force: bool = False) -> dict:
    ...
    from version import APP_VERSION, ASSET_VERSION, BUILD_DATE, CHANNEL, GIT_BRANCH, GIT_COMMIT, COMMIT_SHORT, IMAGE_TAG, DISPLAY_BRANCH, DISPLAY_COMMIT, DISPLAY_IMAGE_TAG
