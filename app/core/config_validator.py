...
_FLOATS: frozenset[str] = frozenset({
    ...
    "meter_snapshot_min_delta_kwh",
    "missing_charge_meter_min_delta_kwh",
    "missing_charge_meter_max_delta_kwh",
...
_INTS: frozenset[str] = frozenset({
    ...
    "meter_snapshot_heartbeat_minutes",
    "meter_snapshot_max_error_rows",
